...
//		Train in=new Train(1,"Harshitha","Hyderabad",25);
//		client_1.insertData(in);
//		Train in1=new Train(2,"Ashwitha","Nakrekal",18);
//		client_1.insertData(in1);
//		Train in2=new Train(3,"Keerthi","Karimnagar",10);
//		client_1.insertData(in2);
//		
		Train in3=new Train(4,"Maripally","Hyderabad",10);
		client_1.insertData(in3);
		Train in4=new Train(5,"Maripally","Hyderabad",43);
